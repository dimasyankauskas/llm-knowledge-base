...
class TestExpandQueryDeterministic:
    def test_expand_query_includes_original_first(self):
        from scripts.query import expand_query
    ...
    def test_expand_query_deduplicates(self):
        ...
        result = expand_query("RAG RAG rag")
    ...
    def test_expand_query_caps_at_five(self):
        ...
        result = expand_query("this is a longer question about retrieval augmented generation and grounding")
        assert len(result) <= 5
